L.Control.Basemaps = L.Control.extend({
    ...
    onAdd: function(map) {
        ...
        this.options.basemaps.forEach(function(d, i) {
            ...
            var imgNodeText = L.DomUtil.create("p", null, basemapNode);
            if (d.options && d.options.label) {
               imgNodeText.innerHTML = d.options.label;
            }
            imgNodeText.style.textAlign = "center";
            imgNodeText.style.width = "68px";
