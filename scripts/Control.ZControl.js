L.Control.ZControl = L.Control.Layers.extend({
	options: {
		collapsed: true,
		position: 'topright',
		autoZIndex: false
...
L.control.zcontrol = function (baseLayers, overlays, options) {
	return new L.Control.ZControl(baseLayers, overlays, options);
};