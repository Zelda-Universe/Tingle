/*  Tile Carver for Photoshop (modified by Nate, only tested in CS3)
  ...
  Another Source: https://github.com/Aplusplus/maptailor.js
*/

//**** YOU SHOULD CUSTOMIZE THE FOLLOWING VARIABLE DEPENDING ON YOUR NEED ****
var HighestZoomLevel = 8; // Enter the highest zoom level we are creating tiles for (should be less than OrgZoomLevel; technically the script should be able to handle values larger as well, but your image quality will suffer)
